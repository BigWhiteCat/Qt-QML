...
TeamLeadersDialog::TeamLeadersDialog(const QStringList &leaders, QWidget *parent) : QDialog(parent) {
    ...
    connect(deleteButton, SIGNAL(clicked()), this, SLOT(insert()));
    ...
    setWindowTitle(tr("Predefined model"));
}
